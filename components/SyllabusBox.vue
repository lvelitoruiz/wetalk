      ...
      <BoxContainer color="pink">
        ...
        <div class="flex items-center gap-4 mb-[22px]">
          ...
          <div v-if="!props.tabShow" class="flex items-center my-1.5">
            ...
            <button
              class="bg-[#E50A17] rounded-full ml-6 h-[31px] w-[31px] flex items-center justify-center lg:hidden"
              @click="downloadFile()"
            >
              <svg
        ...
        <div
          class="pink-scroll min-h-[260px] lg:min-h-[422px]"

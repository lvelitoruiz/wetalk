...
<template>
    <div class="card-container" role="button" tabindex="1">
        <div class="overflow-hidden px-2">
            <h4 class="card-title-week" :title="course.DescEspecialCurso">
            ...
            <div class="text-[0.7rem] mb-1">
                <p class="text-secondary-400 leading-[1]"
                    :class="{'inline-block': !Boolean(listP[course.IdSesion].docentes.length)}"
                >Profesor:</p>
        ...
        <div class="mt-auto ml-auto mr-[2px] lg:mr-1 text-primary rounded-[4px] hover:bg-[#E50A17] hover:text-[#FFFFFF]" v-bind:class="{ 'bg-[#E50A17] !text-[#FFFFFF]': popupIsVisible }">

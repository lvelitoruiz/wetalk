...
<div class="content_destacados">
    <ClientOnly>
        ...
        >
            <SwiperSlide v-for="page in dataList" :key="page.id">
                <slot :item="page"></slot>
            </SwiperSlide>
            <div class="c-navigation_destacados">
                <div class="swiper-button-prev" id="prev" :class="dataList?.length > 5 ? 'hide-mobile': ''" ></div>
                <div class="swiper-pagination"></div>
                <div class="swiper-button-next" id="next" :class="dataList?.length > 5 ? 'hide-mobile': ''" ></div>
            </div>
        </Swiper>
    </ClientOnly>
</div>
...
.content_destacados .swiper-pagination-horizontal.swiper-pagination-bullets

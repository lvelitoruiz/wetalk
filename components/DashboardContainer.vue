  ...
  <div class="lg:flex flex-col gap-6">
    ...
    >
      <div>
        ...
        <p
          class="text-[#191919] text-[18px] leading-6 lg:pb-[18px] pb-9 mt-2 whitespace-nowrap"
        >
      ...
      >
        ...
        <div
          class="lg:w-[calc(100%-100px)] w-full flex items-center justify-between"
        >
          <div class="px-3">
            ...
            <p
              v-if="dataMeta !== null && metaText === ''"
              class="text-sm text-[#A6A6A6] font-light"
            >
              Cuéntanos tu meta al estudiar inglés, y alcancémosla juntos 🏁🏆
            </p>
          </div>
          <router-link
            @click="eventClickMeta('Ver meta', '/meta')"
            to="/meta"

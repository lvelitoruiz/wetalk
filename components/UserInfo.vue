<template>
  <UserName :name="name" :code="code" />
  <AcademicInfo :inst="inst" :mod="mod" :level="level" :carr="carr" :mail="mail" :dni="dni" />
  <ContactInformation :pmail="pmail" :number="number" />
</template>

function handler(event) {
    ...
    var imgSrc = "img-src 'self' www.facebook.com data: *.googletagmanager.com www.google.com www.google.com.pe  *.doubleclick.net *.upc.edu.pe *.upn.edu.pe *.stage01.link *.wetalk.pe res.cloudinary.com www.google-analytics.com fonts.gstatic.com static.getclicky.com t.co analytics.twitter.com pixel.mathtag.com leadsglobal.go2cloud.org *.teads.tv analytics.tiktok.com ads.sonataplatform.com *.clarity.ms";
    var fontSrc = "font-src 'self' data: *.upc.edu.pe *.upn.edu.pe  stordatamiupc.blob.core.windows.net fonts.gstatic.com";

    var connectSrc = "connect-src 'self' in.getclicky.com  searchs-open-portals.azurewebsites.net *.upc.edu.pe *.upn.edu.pe *.stage01.link *.wetalk.pe *.googletagmanager.com *.google-analytics.com viveupc.pe  *.doubleclick.net *.stage01.link *.wetalk.pe analytics.google.com eu2.device-api.indigitall.com n2.mouseflow.com vc.hotjar.io *.teads.tv analytics.tiktok.com *.clarity.ms *.microsoftonline.com";
